...
const IMGBB_API_KEY = "f048c857d1c61df16a650b4b65074368";
 const TRANSLATIONS = {
            'English': {
                ...
                likedYourPost: 'liked your post', commentedOnYourPost: 'commented on your post', writeComment: 'Write a comment...', postComment: 'Post', commentsTitle: 'Comments', weeklyRank: 'Weekly Rank', editPrompt: 'Edit Prompt', deletePost: 'Delete Post', copies: 'copies', reportPost: 'Report Post'
            },
            'Sinhala (සිංහල)': {
                ...
                likedYourPost: 'ඔබේ පෝස්ට් එකට ලයික් කළා', commentedOnYourPost: 'ඔබේ පෝස්ට් එකට කමෙන්ට් කළා', writeComment: 'කමෙන්ට් එකක් ලියන්න...', postComment: 'පළ කරන්න', commentsTitle: 'කමෙන්ට්ස්', weeklyRank: 'සතියේ ස්ථානය', editPrompt: 'වෙනස් කරන්න', deletePost: 'මකා දමන්න', copies: 'පිටපත්', reportPost: 'වාර්තා කරන්න'
            },
            'Spanish (Español)': {
            ...
            'French (Français)': {
                ...
                privacy: 'Confidentialité', public: 'Public', followersOnly: 'Abonnés Uniquement', private: 'Privé', birthday: 'Anniversaire', age: 'Âge', hobbies: 'Loisirs', addHobby: 'Ajouter un loisir',
                likedYourPost: 'a aimé votre publication', commentedOnYourPost: 'a commenté votre publication', writeComment: 'Écrire un commentaire...', postComment: 'Publier', commentsTitle: 'Commentaires', weeklyRank: 'Classement Hebdomadaire', editPrompt: 'Modifier', deletePost: 'Supprimer', copies: 'copies', reportPost: 'Signaler'
            },
            'German (Deutsch)': {
                ...
                privacy: 'Datenschutz', public: 'Öffentlich', followersOnly: 'Nur Follower', private: 'Privat', birthday: 'Geburtstag', age: 'Alter', hobbies: 'Hobbys', addHobby: 'Hobby hinzufügen',
                likedYourPost: 'hat dein Beitrag gefallen', commentedOnYourPost: 'hat deinen Beitrag kommentiert', writeComment: 'Schreibe einen Kommentar...', postComment: 'Posten', commentsTitle: 'Kommentare', weeklyRank: 'Wöchentlicher Rang', editPrompt: 'Bearbeiten', deletePost: 'Löschen', copies: 'Kopien', reportPost: 'Melden'
            },
            'Chinese (中文)': {
                ...
                privacy: '隐私', public: '公开', followersOnly: '仅粉丝', private: '私密', birthday: '生日', age: '年龄', hobbies: '爱好', addHobby: '添加爱好',
                likedYourPost: '赞了你的帖子', commentedOnYourPost: '评论了你的帖子', writeComment: '写评论...', postComment: '发布', commentsTitle: '评论', weeklyRank: '每周排名', editPrompt: '编辑', deletePost: '删除', copies: '复制', reportPost: '举报'
            },
            'Japanese (日本語)': {
                ...
                privacy: 'プライバシー', public: '公開', followersOnly: 'フォロワーのみ', private: '非公開', birthday: '誕生日', age: '年齢', hobbies: '趣味', addHobby: '趣味を追加',
                likedYourPost: 'あなたの投稿に「いいね」しました', commentedOnYourPost: 'あなたの投稿にコメントしました', writeComment: 'コメントを書く...', postComment: '投稿', commentsTitle: 'コメント', weeklyRank: '週間ランク', editPrompt: '編集', deletePost: '削除', copies: 'コピー', reportPost: '報告'
            },
            'Arabic (العربية)': {
                ...
                privacy: 'الخصوصية', public: 'عام', followersOnly: 'المتابعون فقط', private: 'خاص', birthday: 'تاريخ الميلاد', age: 'العمر', hobbies: 'الهوايات', addHobby: 'إضافة هواية',
                likedYourPost: 'أعجب بمنشورك', commentedOnYourPost: 'علق على منشورك', writeComment: 'اكتب تعليقاً...', postComment: 'نشر', commentsTitle: 'التعليقات', weeklyRank: 'التصنيف الأسبوعي', editPrompt: 'تعديل', deletePost: 'حذف', copies: 'نسخ', reportPost: 'إبلاغ'
            },
            'Hindi (हिन्दी)': {
                ...
                privacy: 'गोपनीयता', public: 'सार्वजनिक', followersOnly: 'केवल फॉलोअर्स', private: 'निजी', birthday: 'जन्मदिन', age: 'उम्र', hobbies: 'शौक', addHobby: 'शौक जोड़ें',
                likedYourPost: 'ने आपकी पोस्ट को लाइक किया', commentedOnYourPost: 'ने आपकी पोस्ट पर टिप्पणी की', writeComment: 'एक टिप्पणी लिखें...', postComment: 'पोस्ट करें', commentsTitle: 'टिप्पणियाँ', weeklyRank: 'साप्ताहिक रैंक', editPrompt: 'संपादित करें', deletePost: 'हटाएं', copies: 'प्रतियां', reportPost: 'रिपोर्ट करें'
            },
            'Russian (Русский)': {
                ...
                privacy: 'Конфиденциальность', public: 'Публичный', followersOnly: 'Только подписчики', private: 'Приватный', birthday: 'День рождения', age: 'Возраст', hobbies: 'Хобби', addHobby: 'Добавить хобби',
                likedYourPost: 'понравилась ваша публикация', commentedOnYourPost: 'прокомментировал вашу публикацию', writeComment: 'Написать комментарий...', postComment: 'Отправить', commentsTitle: 'Комментарии', weeklyRank: 'Еженедельный Рейтинг', editPrompt: 'Редактировать', deletePost: 'Удалить', copies: 'копий', reportPost: 'Пожаловаться'
            }
        };
        ...
        const App = () => {
            ...
            useEffect(() => {
                ...
                const unsubNotifs = onSnapshot(collection(db, 'artifacts', appId, 'public', 'data', 'notifications'), (snap) => {
                    ...
                    // 🚀 FIXED: Real-time Count & Instant Read Filter
                    const unreadCount = fetched.filter(n => !n.read).length;
                    setHasUnreadNotifications(unreadCount > 0 ? unreadCount : false);
                            ...
                            <div className="flex items-center gap-2 md:gap-6 flex-shrink-0">
                                ...
                                <div className="hidden md:flex items-center gap-6 mr-2 border-r border-slate-200 dark:border-slate-700 pr-6">
                                    ...
                                    {hasAdminAccess && <button onClick={() => navigate('admin_panel')} className={`transition-colors relative hover:scale-110 ${view === 'admin_panel' ? 'text-red-500' : 'text-slate-400 dark:text-slate-500 hover:text-red-500'}`}>
                                        <Icon name="sliders" />
                                        {allReports.length > 0 && <span className="absolute -top-1.5 -right-2 bg-red-500 text-white text-[9px] font-black w-4 h-4 flex items-center justify-center rounded-full border-2 border-white dark:border-slate-900 shadow-md animate-pulse">{allReports.length}</span>}
                                    </button>}
                    ...
                    <main className="max-w-7xl mx-auto px-4 md:px-6 py-6 md:py-8 w-full flex gap-8 justify-center">
                        ...
                        <aside className="hidden lg:flex flex-col w-[260px] flex-shrink-0 sticky top-28 h-fit space-y-2">
                            {hasAdminAccess && <button onClick={() => navigate('admin_panel')} className={`flex justify-between items-center p-4 rounded-2xl font-black transition-all mb-4 ${view === 'admin_panel' ? 'bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 border border-red-100 dark:border-red-900/50 shadow-sm' : 'text-slate-400 dark:text-slate-500 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-red-500'}`}>
                                ...
                                {allReports.length > 0 && <span className="bg-red-500 text-white text-[10px] w-5 h-5 flex items-center justify-center rounded-full animate-pulse shadow-md">{allReports.length}</span>}
                            </button>}
                        ...
                        <span>{t('alerts')}</span>
                        {hasUnreadNotifications && (
                            <span className="absolute top-3 left-6 bg-red-500 text-white text-[10px] font-black w-5 h-5 rounded-full flex items-center justify-center border-2 border-white dark:border-slate-900 shadow-md">
                                {hasUnreadNotifications}
                            </span>
                        )}
                    </button>
                                        ...
                                        {notifications.length === 0 ? <div className="text-center py-16"><Icon name="belloff" className="w-12 h-12 text-slate-200 dark:text-slate-700 mx-auto mb-4" /><p className="text-slate-400 font-bold text-xs uppercase">No new alerts.</p></div> : notifications.map(notif => {
                                            ...
                                            return (
                                                <div key={notif.id} onClick={async () => { 
                                                    ...
                                                    <div className="flex-1 pt-1"><p className="font-extrabold text-[15px] text-slate-900 dark:text-white">{displayName} <span className="font-medium text-slate-500 dark:text-slate-400">{notif.type === 'follow' ? t('followedYou') : notif.type === 'like' ? (t('likedYourPost') || 'liked your post') : (t('commentedOnYourPost') || 'commented on your post')}</span></p>{notif.commentText && <p className="text-xs text-slate-600 dark:text-slate-400 mt-1 italic">"{notif.commentText}"</p>}<p className="text-[10px] font-black text-blue-500 dark:text-blue-400 uppercase mt-2">{!notif.read && <span className="inline-block w-2 h-2 bg-blue-500 rounded-full mr-2"></span>}Alert</p></div>
                                                </div>
                                            );
                                        })}
                                    </div>
                                                                ...
                                                                <div className="flex-1">
                                                                    ...
                                                                    <div className="flex items-center gap-4 mt-1.5 ml-2">
                                                                        <button onClick={() => toggleCommentLike(c.id)} className={`text-[10px] font-extrabold transition-colors flex items-center gap-1 ${c.likes?.includes(user?.uid) ? 'text-blue-600 dark:text-blue-400' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200'}`}>
                                                                            ...
                                                                            <button onClick={() => {
                                                                         const author = allCreators.find(u => u.id === c.userId);
                                                                         setCommentModal({
                                                                         ...commentModal, 
                                                                         replyingTo: { ...c, userName: author?.name || c.userName }
                                                                            });
                                                                          }} className="text-[10px] font-extrabold text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors">
                                                                            Reply
                                                                        </button>
                                                                    </div>
                                                                </div>
                                    ...
                                    <div className="p-4 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 relative z-20">
                                        ...
                                        {commentModal.replyingTo && (
                                            <div className="absolute -top-10 left-0 w-full bg-blue-50 dark:bg-blue-900/20 px-4 py-2 text-[11px] font-bold text-blue-700 dark:text-blue-400 flex items-center justify-between border-t border-blue-100 dark:border-blue-900/30">
                                                <span>Replying to @{allCreators.find(u => u.id === commentModal.replyingTo.userId)?.name || commentModal.replyingTo.userName}</span>
